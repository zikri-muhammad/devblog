...
/*-----------------------------------------------------------------------------------------------------------------------*/
     ...
     */
    $wp_customize->add_section(
        'news_portal_sidebar_sticky_section',
        array(
            'title'     => esc_html__( 'Sidebar Sticky Settings', 'news-portal' ),
            'panel'     => 'news_portal_additional_settings_panel',
            'priority'  => 20,
        )
    );
     ...
     */
    $wp_customize->add_setting(
        'news_portal_inner_sidebar_sticky_option',
        array(
            'default' => 'show',
            'sanitize_callback' => 'news_portal_sanitize_switch_option',
        )
    ...
    $wp_customize->add_control( new News_Portal_Customize_Switch_Control(
        $wp_customize,
            ...
            array(
                'type'      => 'switch',
                'label'     => esc_html__( 'Innerpage Sticky', 'news-portal' ),
                'description'   => esc_html__( 'Enable/Disable sticky sidebar for innperpages like( archive, single, search ) pages.', 'news-portal' ),
                'section'   => 'news_portal_sidebar_sticky_section',
                'choices'   => array(
                    'show'  => esc_html__( 'Enable', 'news-portal' ),
                    'hide'  => esc_html__( 'Disable', 'news-portal' )
                    ),
